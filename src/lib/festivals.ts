...
export const festivals: Festival[] = [
  {
    ...
    descriptionEn: 'Celebration of love and friendship. Red color prevails in clothes, gifts and details are exchanged between friends and lovers. Ideal for couples who want to get engaged or get married.',
  ...
  },
  {
    ...
    descriptionEn: 'Festivity in the Andean part where they thank and rejoice with nature for the production before the harvest. The first fruits of the main foods are ready to be picked, dancing and singing around trees full of gifts and surprises.',
  ...
  },
  {
    ...
    descriptionEn: 'Celebration remembering the death and passion of Christ. Cusco has its particular way of celebrating, eating 12 dishes in commemoration of the last supper. Local families prepare meals and desserts, making crosses with palm branches, rosemary and other plants. Procession of the Lord of Miracles.',
  ...
  },
  {
    ...
    descriptionEn: 'Colonial tradition where more than 12 saints and virgins from different districts of Cusco go in procession to the main square. The main dish is Chiriuchu: fish roe, seaweed, pumpkin fritter, toasted corn, jerky, chicken, sausage, lamb, guinea pig, hot pepper, cheese.',
  ...
  },
  {
    ...
    nameEn: 'Inti Raymi - Sun Festival',
    ...
    descriptionEn: 'Celebration commemorating one of the main festivals of the Inka culture, with spectacular staging where the main protagonists are the Inka and the Qoya, chiefs of the 4 suyos, priests, sun virgins, military and warriors. Qoricancha, the main square and Sacsayhuaman are the places where this staging takes place.',
  ...
  },
  {
    ...
    descriptionEn: 'The joy for the independence of Peru dresses all citizens of the country in red and white, performing a series of civic and traditional activities in the different provinces and districts of the Cusco region.',
  ...
  },
  {
    ...
    descriptionEn: 'Ancestral custom where mother nature is revered. All Cusco residents make different offerings and keep alive the tradition of offering different products from the first day of August in gratitude for the start of agricultural activity.',
  ...
  },
  {
    ...
    descriptionEn: 'Main date of the change of season. Spring where all crop fields are already full of food products in full growth. The presence of rains confers a magical and full of life aspect to the entire region. Students are also celebrated.',
  ...
  },
  {
    ...
    descriptionEn: 'Religious faith fills the streets of the city of Cusco with purple color for the procession of the Lord of Miracles. Halloween is also part of the celebration, where the main square is crowded with children and disguised people sharing sweets and candies.',
  ...
  },
  {
    ...
    descriptionEn: 'Celebration in commemoration of people and the deceased. Different ceremonies are held in commemoration of different personalities and ancestors. Party that combines ancient tradition with visits to cemeteries and tasting typical dishes such as baked piglet with corn tamales.',
  ...
  },
  {
    ...
    descriptionEn: 'Festival that celebrates the birth of Jesus, with the traditional artistic sale "Santuranticuy" exhibiting nativities and biblical costumes. The last day of the year is celebrated in the main square wearing cabalistic colors to welcome the new year.',
